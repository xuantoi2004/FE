                ...
                <div class="flex">
                    ...
                    <div class="w-1/3 flex flex-col ml-3">
                        <div class="bg-white py-3 px-3 flex flex-col rounded-lg">
                            ...
                            <div
                                class="flex bg-blue-200 text-green-600 text-sm mt-1 py-2 px-3 justify-between rounded-lg">
                        ...
                        <div class="bg-white py-3 px-3 flex flex-col rounded-lg mt-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="font-bold text-green-700">{{ (cartStore.totalPrice).toLocaleString() }} đ
                                </div>
                            </div>
