    ...
    <div class="bg-slate-50 py-2.5">
        <div class="w-5/6 mx-auto">
            ...
            <div class="flex my-3 text-sm items-center gap-x-3 uppercase">
                ...
                &rArr;
                <NuxtLink :to="'/category/' + product.result.category.goodCategory.id">{{
                    product.result.category.goodCategory.goodName }}</NuxtLink>
                &rArr;
                <NuxtLink :to="'/category/' + product.result.category.id">{{ product.result.category.categoryName }}
                </NuxtLink>
                &rArr;
            ...
            <div class="bg-white rounded-lg">
                <div class="flex p-4 gap-x-3">
                    ...
                    <div class="flex w-8/12 flex-col">
                        <p class="font-semibold text-2xl text-green-600">{{ product.result.name }}</p>
                        ...
                        <div class="flex items-center mt-4">
                            <div class="text-green-600 font-bold text-3xl mr-3">
                    ...
                    product.result.price).toLocaleString() }}
                            ...
                            <div class="bg-red-700 font-semibold text-white p-1 rounded-md text-sm">-{{
                    product.result.discount }}%
                        ...
                        <div class="flex mt-4">
                            <button @click="addCart"
                                class="py-2 px-6 border-2 border-green-600 rounded-lg flex items-center text-green-600 font-bold cursor-pointer  hover:shadow-md">
                                <IconCart class="mr-2" /> Thêm vào giỏ hàng
                            </button>
                            <div @click="buyNow"
                                class="bg-green-600 text-white py-2 px-10  rounded-lg font-bold cursor-pointer ml-2 hover:shadow-md">
                                Mua ngay
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-4 bg-white rounded-lg">
                <div class="flex font-bold text-xl items-center p-4 text-green-600">
                    <IconCoupon class=" mr-4" /> ƯU ĐÃI LIÊN QUAN
                </div>
                <div class="flex p-4">
                ...
                <div class="px-4 pb-4 relative">
                    ...
                    <div class="border-b-2 border-green-500 w-1/12 absolute"></div>
                </div>
                <div class="p-4 flex flex-row items-center">
                    ...
                    <div class="flex items-center text-md flex-col ml-auto">
                        ...
                        <div class="font-semibold text-xs text-green-500">
                            Xem thêm Mã
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-4 bg-white rounded-lg flex flex-col p-4">
                <div class="font-bold mb-4 text-green-600">SẢN PHẨM LIÊN QUAN</div>
                <div>
                    <div class="font-semibold text-green-500 mb-2">Series</div>
                    <div class="border-b-2 border-green-500 w-1/12 mb-2"></div>
                </div>
