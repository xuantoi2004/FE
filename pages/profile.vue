        ...
        <div class="w-5/6 mx-auto">
            <div class="flex mt-2">
                <div class="w-3/12 flex flex-col mr-3">
                    <div class="font-bold text-xl text-green-600 p-4 border-b-2 bg-white shadow-md uppercase">
                        Quản lý TÀI KHOẢN
                    </div>
                    <div class="p-4 bg-white shadow-md">
                        <div class="border-b py-3 text-sm cursor-pointer" @click="showDashboardTab"
                            :class="{ 'text-green-700': isDashboardTab }">
                            Bảng điều khiển tài khoản
                        </div>
                        <div class="border-b py-3 text-sm cursor-pointer" @click="showProfileTab"
                            :class="{ 'text-green-700': isProfileTab }">
                            Thông tin tài khoản
                        </div>
                ...
                <div class="w-9/12 flex flex-col">
                    <ProfileDashboard v-if="isDashboardTab" :class="{ hidden: !isDashboardTab }"
                        v-bind:user="user.result" @update-user="showProfileTab" />
