        ...
        <div class="w-5/6 mx-auto">
            <div class="flex flex-col my-4 gap-y-3">
                <div class="flex bg-rose-600 gap-x-2 p-4 items-center justify-between">
                    ...
                    <NuxtLink to="/profile#invoice"
                        class="uppercase text-sm border-2 border-red-500 rounded w-1/6 py-4 px-2 text-center text-red-500 font-semibold cursor-pointer bg-rose-200 hover:text-white hover:border-white">
                        Xem chi tiết đơn hàng
                    </NuxtLink>
                    <NuxtLink to="/"
                        class="uppercase text-sm rounded w-1/6 py-4 px-2 text-center text-white font-semibold cursor-pointer bg-red-500 hover:border-white hover:border-2">
                        Tiếp tục mua sắm
                    </NuxtLink>
                </div>
                <div class="bg-white">
                    ...
                    <div class="flex border-b border-r border-l" v-for="ivc in invoice.invoiceChild" :id="ivc.id">
                        ...
                        <div class="w-1/12 flex flex-col p-4">
                            ...
                            <div class="text-gray-300 line-through">{{ ((ivc.product.discount / 100) * ivc.product.price +
                            ivc.product.price).toLocaleString() }} đ</div>
                        </div>
                        <div class="w-2/12 p-4">
                            {{ ivc.qty }}
                        </div>
