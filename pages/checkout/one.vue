            ...
            <div class="flex flex-col gap-y-4 my-4">
                ...
                <div class="bg-white px-4 py-1.5">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="w-1/12 flex justify-center text-gray-800">
                            <input type="radio" name="address" value="1" v-model="address_option"
                                class=" border-green-500" checked>
                        </div>
                        <div class="w-10/12">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="w-1/12 flex justify-center text-gray-800">
                            <input type="radio" name="address" v-model="address_option" value="2"
                ...
                <div class="bg-white px-4 py-1.5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="w-11/12">
                            <input type="text" class="border rounded px-2 py-1.5 outline-none w-1/3"
                                placeholder="nhập số điện thoại" v-model="invoice.phone">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white">
                        ...
                        <div class="flex border-b border-r border-l" v-for="product in cartStore.cart" :id="product.id">
                            ...
                            <div class="w-1/12 flex flex-col p-4">
                                ...
                                <div class="text-gray-300 line-through">{{ (product.price * product.discount +
                                product.price).toLocaleString() }} đ</div>
                            </div>
                            <div class="w-2/12 p-4">
                                {{ product.qtyItem }}
                            </div>
                ...
                <div class="bg-white px-4 py-1.5">
                    ...
                    <div class="flex justify-between p-4 items-center">
                        ...
                        <button
                            class="w-4/12 bg-gray-800 text-white px-4 py-2 rounded-lg uppercase text-center font-semibold hover:bg-rose-600"
                            @click="addInvoice">
